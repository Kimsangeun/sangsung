...
<form name="frm" action="ProdQnAModifyReg" method="post" enctype="multipart/form-data">
...
<hr style="margin-bottom: 10px;">
	<div class="tt">
		<a href="ProdQnAList" >목록</a> |
		<a href="ProdQnADetail?id=${data.id }&seq=${param.seq}">취소</a>
